...
- (void)viewDidLoad
{
    ...
    NSString *firstString = @"I am in section 0";
    NSString *secondString = @"another section";
    
    [self.firstArray addObject:firstString];
    [self.firstArray addObject:firstString];
    [self.secondArray addObject:secondString];
}
